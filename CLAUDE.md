...
This project is indexed by GitNexus as **tdgames-platform** (5285 symbols, 10451 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
