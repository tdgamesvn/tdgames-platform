// VÔ HIỆU HOÁ 2026-08-26 — rac TD Workflow — dung fb_clickup_tokens (khong ton tai). Proxy ClickUp endpoint tuy y. 0 cho goi.
//
...
Deno.serve(() =>
  new Response(
    JSON.stringify({ error: "Gone", message: "clickup-proxy da bi vo hieu hoa (2026-08-26)." }),
