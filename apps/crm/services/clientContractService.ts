...
<div class="article">
  ...
  <p style="font-weight:bold;margin:6px 0 2px">1.1 ${t('Party A (Client)', 'Bên A (Khách hàng)')}</p>
  ...
  <p style="font-weight:bold;margin:6px 0 2px">1.2 ${t('Party B (Service Provider)', 'Bên B (Đơn vị cung cấp dịch vụ)')}</p>
  <table class="info-table">
...
<div class="article">
  ...
  <div class="bilingual" style="margin-top:6px">
    <p class="en">Any delay caused by late feedback, missing references, or change requests from Party A shall extend the production schedule accordingly. Party B shall notify Party A in writing of the specific number of days of extension and the resulting completion date within three (03) working days from the date the delay arises. Failure to give such notice does not deprive Party B of the extension, but Party B must then evidence the number of days of delay from the Parties' correspondence.</p>
    <p class="vi">Trong trường hợp tiến độ bị ảnh hưởng do Bên A chậm phản hồi, thiếu tài liệu tham chiếu hoặc yêu cầu thay đổi, thời hạn thực hiện được gia hạn tương ứng. Bên B phải thông báo cho Bên A bằng văn bản số ngày gia hạn cụ thể và ngày hoàn thành mới trong vòng 3 ngày làm việc kể từ ngày phát sinh chậm trễ. Việc không thông báo không làm mất quyền gia hạn của Bên B, nhưng khi đó Bên B phải chứng minh số ngày chậm trễ căn cứ lịch sử trao đổi giữa các Bên.</p>
  </div>
</div>
...
<div class="article">
  ...
  <p style="font-weight:bold;margin:6px 0 2px">4.2 ${t('Payment Schedule', 'Lịch thanh toán')}</p>
  ...
  <p style="font-weight:bold;margin:8px 0 2px">4.3 ${t('Payment Method', 'Phương thức thanh toán')}</p>
  <div class="bilingual">
  ...
  <p style="font-weight:bold;margin:8px 0 2px">4.4 ${t('Value Added Tax', 'Thuế giá trị gia tăng')}</p>
  <div class="bilingual">
    ${dom
...
<div class="article">
  ...
  <p style="font-weight:bold;margin:4px 0 2px">5.1 ${t('Obligations of Party B (Service Provider)', 'Nghĩa vụ của Bên B')}</p>
  <ul>
    ...
    <li>${t('Deliver all products on time and in conformity with the technical specifications set out in Article II or the Technical Appendix. Where a specification is not stated, industry-standard practice for the relevant deliverable applies.', 'Bàn giao tất cả sản phẩm đúng hạn và phù hợp với thông số kỹ thuật nêu tại Điều II hoặc Phụ lục kỹ thuật. Trường hợp một thông số không được nêu, áp dụng thông lệ tiêu chuẩn của ngành đối với sản phẩm tương ứng.')}</li>
  ...
  <p style="font-weight:bold;margin:6px 0 2px">5.3 ${t('Intellectual Property Rights', 'Quyền sở hữu trí tuệ')}</p>
  <div class="bilingual">
...
<div class="article">
  ...
  <p style="font-weight:bold;margin:6px 0 2px">6.3 ${t('Confidentiality', 'Bảo mật thông tin')}</p>
  <div class="bilingual">
  ...
  <p style="font-weight:bold;margin:6px 0 2px">6.4 ${t('Governing Law', 'Luật điều chỉnh')}</p>
  <div class="bilingual">
  ...
  <p style="font-weight:bold;margin:6px 0 2px">6.5 ${t('Contract Termination', 'Chấm dứt hợp đồng')}</p>
  <div class="bilingual">
    <p class="en">Either Party may request termination with twenty (20) calendar days written notice. Where Party A terminates for reasons not attributable to Party B, Party A shall, in addition to paying for completed work, pay a compensation equal to fifteen percent (15%) of the value of the remaining unperformed work, covering resources already reserved for the project. In all cases Party A shall pay for work completed up to the effective date of termination on a pro-rata basis, and amounts already received corresponding to such completed work are non-refundable. Where termination results from a breach by Party B, Party B shall refund any amount received in excess of the value of the work actually completed. Termination does not affect either Party's liability for damages arising from its breach.</p>
    <p class="vi">Mỗi Bên có thể yêu cầu chấm dứt với 20 ngày thông báo bằng văn bản. Trường hợp Bên A chấm dứt vì lý do không thuộc lỗi của Bên B, ngoài việc thanh toán khối lượng đã hoàn thành, Bên A thanh toán một khoản bù bằng 15% giá trị phần công việc chưa thực hiện, tương ứng nguồn lực Bên B đã bố trí cho dự án. Trong mọi trường hợp, Bên A thanh toán cho khối lượng công việc đã hoàn thành đến ngày chấm dứt theo tỷ lệ, và khoản đã nhận tương ứng với phần công việc đó không được hoàn lại. Trường hợp chấm dứt do lỗi vi phạm của Bên B, Bên B phải hoàn trả phần đã nhận vượt quá giá trị công việc thực tế đã hoàn thành. Việc chấm dứt không làm ảnh hưởng đến trách nhiệm bồi thường thiệt hại của Bên vi phạm.</p>
  </div>

  <p style="font-weight:bold;margin:6px 0 2px">6.6 ${t('Late Payment &amp; Penalty for Breach', 'Chậm thanh toán và phạt vi phạm')}</p>
  <div class="bilingual">
  ...
  <p style="font-weight:bold;margin:6px 0 2px">6.7 ${t('Force Majeure', 'Sự kiện bất khả kháng')}</p>
  <div class="bilingual">
  ...
  <p style="font-weight:bold;margin:6px 0 2px">6.8 ${t('Governing Language', 'Ngôn ngữ của Hợp đồng')}</p>
  <div class="bilingual">
    ${L === 'both'
  ...
  <p style="font-weight:bold;margin:6px 0 2px">6.11 ${t('Working Days', 'Ngày làm việc')}</p>
  <div class="bilingual">
