  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'tips',
        items: [
          '<strong>Phép năm</strong> — Theo chính sách công ty, trừ vào số ngày phép tồn.',
          '<strong>Nghỉ ốm</strong> — Có thể yêu cầu giấy tờ y tế tùy chính sách.',
          '<strong>Nghỉ không lương</strong> — Không trừ phép nhưng trừ lương ngày tương ứng.',
        ],
      },
    ],
  },
