...
export type ExpenseTab = 'dashboard' | 'list' | 'add' | 'recurring' | 'categories' | 'reports' | 'fxrates' | 'cashflow';

const VALID_TABS: ExpenseTab[] = ['dashboard', 'list', 'add', 'recurring', 'categories', 'reports', 'fxrates', 'cashflow'];
